Public Class Despachos
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Next
        Access.ExecQuery("SELECT * FROM Produccion WHERE Despachos IS NOT NULL")
        For Each D As DataRow In Access.DBDT.Rows
            ListBox1.Items.Add(D("Despachos"))
        Next
    End Sub
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        For Each R As DataRow In Access.DBDT.Rows
            ComboBox1.Items.Add(R("Personas"))
        Next
        Access.ExecQuery("SELECT * FROM Compras WHERE Despachos IS NOT NULL")
        For Each D As DataRow In Access.DBDT.Rows
            ListBox1.Items.Add(D("Despachos"))
        Next
    End Sub
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        For Each R As DataRow In Access.DBDT.Rows
            ComboBox1.Items.Add(R("Personas"))
        Next
        Access.ExecQuery("SELECT * FROM Calidad WHERE Despachos IS NOT NULL")
        For Each D As DataRow In Access.DBDT.Rows
            ListBox1.Items.Add(D("Despachos"))
        Next
    End Sub
